...
class Course:
    ...
    def remove_student(self, student):
        ...
        """
        if student in self.enrolled_students: self.enrolled_students.remove(student)
        elif student in self.waitlisted_students: self.waitlisted_students.remove(student)
